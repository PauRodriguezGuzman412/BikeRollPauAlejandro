...
@section('component')
    ...
    <form action="{{ route('admin.courses.store') }}" method="PUT">
        @csrf
        ...
        <textarea name="description"     type="textarea" >{{ old('description','') }}</textarea>    <br>
        ...
        <input name="km"                 type="number"   value="{{ old('km','') }}"                 ><br>
