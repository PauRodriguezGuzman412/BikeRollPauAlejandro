...
@foreach ($recentCourses as $course) 
    <div class="col-5 rounded bg-white me-2">
        ...
        <h4>Precio de inscripción: <span class="fw-bold"> {{ number_format($course->price, 2, ',', '.') }} €</span></h4>
        <h5>{{ $course->description }}</h5>
        <div class="col d-flex justify-content-center">
            <a href="{{ route('courses.registerWithIDForm',$course['id']) }}"><button class="btn btn-primary p-2 fw-bold mt-4">Inscríbete ahora!</button></a>
        </div>
    </div>
